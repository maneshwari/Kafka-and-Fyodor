...
// ═══════════════════════════════════════════════════════════════════
// COMPATIBILITY — every pairing scored & described
// score: 0–100  |  status: one of 5 tiers
// ═══════════════════════════════════════════════════════════════════
...
// Full compatibility matrix — every pair hand-crafted
const COMPATIBILITY = {
  JOSEF_K: {
    GREGOR:         { score: 88, note: "Two people who carry the world in silence. You recognize each other's exhaustion without a word. The danger: you enable each other's self-erasure." },
    ZARATHUSTRA:    { score: 22, note: "Zarathustra is everything Josef K. cannot be — unafraid, ascending, loud. K. finds him exhausting. Zarathustra finds K. tragic. Both are right." },
    DIONYSUS:       { score: 35, note: "The Dionysian's 'yes to everything' bewilders K., who can barely say yes to anything. Fascinating in small doses. Unsustainable as a bond." },
    MEURSAULT:      { score: 60, note: "Both live inside systems that don't fit. But K. fights anxiously; Meursault doesn't register the cage. They are the same problem approached from opposite directions." },
    SISYPHUS:       { score: 55, note: "Sisyphus has made peace with the boulder. K. is still arguing with it. There's respect here — and a gap. K. wonders if Sisyphus is wise or simply resigned." },
    RASKOLNIKOV:    { score: 42, note: "Raskolnikov wants to transcend the system K. is trapped in. Their conversations spiral. Neither can give the other what they need." },
    ALYOSHA:        { score: 70, note: "Alyosha doesn't fix K.'s problem. He just stays. For someone used to being processed by systems, being witnessed is disorienting and quietly healing." },
    UNDERGROUND_MAN:{ score: 78, note: "They understand each other's paralysis. Long silences, then sudden bursts of painful honesty. The risk: they can keep each other stuck." },
    DEMIAN:         { score: 50, note: "Demian sees a door where K. sees a wall. Intriguing, but K. suspects Demian's freedom is a story he tells himself." },
    STEPPENWOLF:    { score: 82, note: "Both are divided men trapped in forms that don't contain them. The bond is immediate and melancholy. They drink together and don't pretend." },
    ROQUENTIN:      { score: 65, note: "Two people who notice what others don't — the absurdity, the excess, the weight of existing. Their conversations are the most honest either of them has." },
  },
  GREGOR: {
    ZARATHUSTRA:    { score: 18, note: "Zarathustra demands becoming. Gregor has spent his life disappearing. The mismatch is almost cruel — though Zarathustra would say the cruelty is necessary." },
    DIONYSUS:       { score: 40, note: "The Dionysian's appetite for life is alien to Gregor, who has learned to want nothing. But occasionally, something in Gregor stirs. Briefly." },
    MEURSAULT:      { score: 45, note: "Meursault doesn't perform care, which is either alienating or a relief. Gregor can't quite tell. There's no obligation here — and that feels strange." },
    SISYPHUS:       { score: 72, note: "Both keep going. Sisyphus by choice; Gregor by habit. Sisyphus might be the one who finally asks Gregor: is this what you want? No one else thought to ask." },
    RASKOLNIKOV:    { score: 30, note: "Raskolnikov's hunger for greatness is incomprehensible to someone who has given everything away. There's pity here, and contempt, and something more complicated." },
    ALYOSHA:        { score: 90, note: "Alyosha loves without condition. For Gregor, who has only known conditional love, this is almost unbearable. He doesn't know what to do with it. He stays anyway." },
    UNDERGROUND_MAN:{ score: 55, note: "The Underground Man sees Gregor's trap clearly and says so, unkindly. It hurts. It's also the most honest thing anyone has said to him." },
    DEMIAN:         { score: 68, note: "Demian looks at Gregor and sees the transformation that hasn't happened yet — the one Gregor is terrified of. He doesn't turn away. That matters." },
    STEPPENWOLF:    { score: 60, note: "Both are living in forms that don't fit. Harry Haller recognizes the exhaustion. He won't romanticize it, which Gregor secretly appreciates." },
    ROQUENTIN:      { score: 75, note: "Roquentin sees the obscene facticity of Gregor's existence — the sheer excessive weight of it — without flinching. This is its own kind of witnessing." },
    JOSEF_K:        { score: 88, note: "Two people who carry the world in silence. You recognize each other's exhaustion without a word. The danger: you enable each other's self-erasure." },
  },
  ZARATHUSTRA: {
    DIONYSUS:       { score: 92, note: "The philosophical alliance. Dionysus provides the fire; Zarathustra gives it direction. Together they are either magnificent or unlivable. Often both." },
    MEURSAULT:      { score: 68, note: "Zarathustra admires Meursault's refusal to perform. But Meursault's passivity frustrates him. 'You see clearly,' Zarathustra wants to say. 'Now DO something.'" },
    SISYPHUS:       { score: 62, note: "Mutual respect between two people who have chosen their burden. They disagree on whether acceptance is victory. The argument is generative." },
    RASKOLNIKOV:    { score: 78, note: "Raskolnikov is what Zarathustra would look like if the philosophy broke him before it made him. Zarathustra sees the ruins of something that could have been great." },
    ALYOSHA:        { score: 38, note: "The deepest philosophical divide in the room. Alyosha's love is everything Zarathustra suspects is a comfortable illusion. They are kind to each other. They do not understand each other." },
    UNDERGROUND_MAN:{ score: 28, note: "The Underground Man is the Last Man Zarathustra fears becoming — paralyzed, spiteful, brilliant and going nowhere. This is not contempt. It is recognition of a near miss." },
    DEMIAN:         { score: 80, note: "Demian is Zarathustra's student who graduated early. The relationship is equal parts admiration and rivalry. Both are trying to live at the edge of what's possible." },
    STEPPENWOLF:    { score: 55, note: "Harry Haller has the will but not the direction. Zarathustra finds him interesting but unresolved. Haller finds Zarathustra's certainty both inspiring and suspect." },
    ROQUENTIN:      { score: 32, note: "Roquentin's nausea is the enemy of everything Zarathustra affirms. They occupy the same philosophical universe and reach opposite conclusions. Cold respect. No warmth." },
    GREGOR:         { score: 18, note: "Zarathustra demands becoming. Gregor has spent his life disappearing. The mismatch is almost cruel — though Zarathustra would say the cruelty is necessary." },
    JOSEF_K:        { score: 22, note: "Zarathustra is everything Josef K. cannot be — unafraid, ascending, loud. K. finds him exhausting. Zarathustra finds K. tragic. Both are right." },
  },
  DIONYSUS: {
    MEURSAULT:      { score: 75, note: "Two people who don't perform. Meursault's stillness intrigues the Dionysian; the Dionysian's aliveness wakes something in Meursault. The most unexpected friendship in the room." },
    SISYPHUS:       { score: 70, note: "Both say yes. But the Dionysian says yes ecstatically; Sisyphus says yes quietly. They complement. Sisyphus steadies the Dionysian; the Dionysian reminds Sisyphus of joy." },
    RASKOLNIKOV:    { score: 60, note: "Raskolnikov's intensity draws the Dionysian in. But Raskolnikov's suffering is not the Dionysian kind — it doesn't transform, it accumulates. The Dionysian grows tired." },
    ALYOSHA:        { score: 65, note: "Different kinds of love. Alyosha loves carefully; the Dionysian loves recklessly. They recognize something real in each other across a significant gap." },
    UNDERGROUND_MAN:{ score: 20, note: "The Underground Man is the anti-Dionysian. Every yes the Dionysian makes, the Underground Man finds a reason to doubt. The relationship is quietly exhausting for both." },
    DEMIAN:         { score: 85, note: "Demian has found his darkness and made it his. The Dionysian has done the same. They are two people who have integrated their shadow — and recognize it in each other." },
    STEPPENWOLF:    { score: 78, note: "Harry Haller needs to learn to dance. The Dionysian can teach him — not the steps, but the permission. The most transformative pairing for Steppenwolf." },
    ROQUENTIN:      { score: 25, note: "Roquentin's nausea and the Dionysian's affirmation are irreconcilable. Not enemies — just utterly alien to each other. Brief contact. Mutual bewilderment." },
    ZARATHUSTRA:    { score: 92, note: "The philosophical alliance. Dionysus provides the fire; Zarathustra gives it direction. Together they are either magnificent or unlivable. Often both." },
    GREGOR:         { score: 40, note: "The Dionysian's appetite for life is alien to Gregor, who has learned to want nothing. But occasionally, something in Gregor stirs. Briefly." },
    JOSEF_K:        { score: 35, note: "The Dionysian's 'yes to everything' bewilders K., who can barely say yes to anything. Fascinating in small doses. Unsustainable as a bond." },
  },
  MEURSAULT: {
    SISYPHUS:       { score: 88, note: "The closest thing to soulmates in this room. Both have looked at meaninglessness and refused to collapse. Meursault feels it; Sisyphus names it. They do not need to talk much." },
    RASKOLNIKOV:    { score: 35, note: "Raskolnikov's guilt is everything Meursault doesn't feel. The gap is too wide for real understanding — though Meursault would listen without judgment, which is more than most offer." },
    ALYOSHA:        { score: 42, note: "Alyosha wants to love Meursault into feeling more. Meursault will not perform the feeling. There is genuine mutual respect — and a wall neither can quite cross." },
    UNDERGROUND_MAN:{ score: 50, note: "Both see through social performance. But the Underground Man seethes; Meursault is simply present. The Underground Man finds this either enviable or infuriating depending on the day." },
    DEMIAN:         { score: 60, note: "Demian sees Meursault's detachment as a threshold, not a destination. Meursault doesn't know what Demian means. He finds him interesting. That's saying something." },
    STEPPENWOLF:    { score: 45, note: "Harry Haller's inner war bewilders Meursault, who has no such war. The gap is wide. But occasionally Harry finds Meursault's stillness more peaceful than anything in himself." },
    ROQUENTIN:      { score: 72, note: "Both notice the raw existence of things. Roquentin is nauseated by it; Meursault is simply there. Roquentin envies this — and suspects it might be its own kind of blindness." },
    ZARATHUSTRA:    { score: 68, note: "Zarathustra admires Meursault's refusal to perform. But Meursault's passivity frustrates him. 'You see clearly — now DO something,' Zarathustra wants to say." },
    DIONYSUS:       { score: 75, note: "Two people who don't perform. Meursault's stillness intrigues the Dionysian; the Dionysian's aliveness wakes something in Meursault. The most unexpected friendship." },
    GREGOR:         { score: 45, note: "Meursault doesn't perform care, which is either alienating or a relief to Gregor. Gregor can't quite tell. There's no obligation here — and that feels strange." },
    JOSEF_K:        { score: 60, note: "Both live inside systems that don't fit. But K. fights anxiously; Meursault doesn't register the cage. Same problem, opposite directions." },
  },
  SISYPHUS: {
    RASKOLNIKOV:    { score: 40, note: "Sisyphus has made peace with what Raskolnikov is still at war with. There's no contempt here — only the mild sadness of watching someone fight a battle they've already lost." },
    ALYOSHA:        { score: 82, note: "Both have chosen to keep going in the face of evidence that stopping would be easier. Alyosha's love and Sisyphus's revolt are different shapes of the same defiant yes." },
    UNDERGROUND_MAN:{ score: 32, note: "Sisyphus has the one thing the Underground Man lacks: the capacity to act despite knowing. The Underground Man finds this either admirable or incomprehensible. Usually the latter." },
    DEMIAN:         { score: 76, note: "Demian is still building his boulder. Sisyphus has been pushing his for years. There's wisdom to offer, if Demian is willing to receive it — and he usually is." },
    STEPPENWOLF:    { score: 48, note: "Steppenwolf romanticizes his suffering; Sisyphus has deprogrammed exactly that. The conversations are useful. Haller resists them. He comes back." },
    ROQUENTIN:      { score: 55, note: "Roquentin sees the nausea at the bottom of things. Sisyphus has been there and named it something else: the foundation for revolt. They are close to the same place." },
    MEURSAULT:      { score: 88, note: "The closest thing to soulmates in this room. Both have looked at meaninglessness and refused to collapse. Meursault feels it; Sisyphus names it. They do not need to talk much." },
    ZARATHUSTRA:    { score: 62, note: "Mutual respect between two who have chosen their burden. They disagree on whether acceptance is victory. The argument is generative." },
    DIONYSUS:       { score: 70, note: "Both say yes. But the Dionysian says yes ecstatically; Sisyphus says yes quietly. They complement each other." },
    GREGOR:         { score: 72, note: "Sisyphus might be the one who finally asks Gregor: is this what you want? No one else thought to ask." },
    JOSEF_K:        { score: 55, note: "Sisyphus has made peace with the boulder. K. is still arguing with it. There's respect and a gap. K. wonders if Sisyphus is wise or simply resigned." },
  },
  RASKOLNIKOV: {
    ALYOSHA:        { score: 55, note: "Alyosha is the person Raskolnikov would need to become to be saved. He knows this. He resists it. He keeps returning to Alyosha anyway, which says everything." },
    UNDERGROUND_MAN:{ score: 80, note: "Two brilliant men who turned their intelligence against themselves. They understand each other's self-destruction in granular detail. The relationship is addictive and dangerous." },
    DEMIAN:         { score: 68, note: "Demian has integrated what Raskolnikov is trying to weaponize. There's a cautionary recognition here — and something that might, over time, be mentorship." },
    STEPPENWOLF:    { score: 62, note: "Both carry a divided self. But Raskolnikov's division is moral; Steppenwolf's is existential. They can drink together without explaining themselves. That's rare." },
    ROQUENTIN:      { score: 58, note: "Roquentin sees Raskolnikov's guilt as a philosophical problem. Raskolnikov finds this cold. But Roquentin's clarity about the weight of existing is the most honest diagnosis he's received." },
    ZARATHUSTRA:    { score: 78, note: "Raskolnikov is what Zarathustra would look like if the philosophy broke him before it made him. Zarathustra sees the ruins of something great." },
    DIONYSUS:       { score: 60, note: "Raskolnikov's intensity draws the Dionysian in. But his suffering accumulates rather than transforms. The Dionysian grows tired." },
    MEURSAULT:      { score: 35, note: "Raskolnikov's guilt is everything Meursault doesn't feel. Too wide a gap — though Meursault would listen without judgment." },
    GREGOR:         { score: 30, note: "Raskolnikov's hunger for greatness is incomprehensible to someone who has given everything away. Pity, contempt, and something more complicated." },
    JOSEF_K:        { score: 42, note: "Raskolnikov wants to transcend the system K. is trapped in. Their conversations spiral. Neither can give the other what they need." },
    SISYPHUS:       { score: 40, note: "Sisyphus has made peace with what Raskolnikov is at war with. The mild sadness of watching someone fight a battle already lost." },
  },
  ALYOSHA: {
    UNDERGROUND_MAN:{ score: 45, note: "Alyosha loves the Underground Man without requiring him to be better. The Underground Man finds this unbearable. He keeps testing it. It keeps holding. He doesn't know what to do with that." },
    DEMIAN:         { score: 80, note: "Both are trying to integrate darkness and light — Alyosha through love, Demian through knowledge. They learn from each other without either fully converting the other." },
    STEPPENWOLF:    { score: 72, note: "Alyosha sees the person inside the war. He doesn't ask Harry to resolve it — just to be present to it. Haller finds this disarming. He was ready for a fight." },
    ROQUENTIN:      { score: 38, note: "Roquentin's nausea and Alyosha's love are at philosophical war. Yet Alyosha listens to the nausea without arguing. This confuses Roquentin more than opposition would." },
    ZARATHUSTRA:    { score: 38, note: "The deepest philosophical divide in the room. Alyosha's love is everything Zarathustra suspects is comfortable illusion. They are kind. They do not understand each other." },
    DIONYSUS:       { score: 65, note: "Different kinds of love. Alyosha loves carefully; the Dionysian loves recklessly. They recognize something real in each other across a significant gap." },
    MEURSAULT:      { score: 42, note: "Alyosha wants to love Meursault into feeling more. Meursault will not perform the feeling. Genuine respect — and a wall neither can quite cross." },
    GREGOR:         { score: 90, note: "Alyosha loves without condition. For Gregor, who has only known conditional love, this is almost unbearable. He doesn't know what to do with it. He stays anyway." },
    JOSEF_K:        { score: 70, note: "Alyosha doesn't fix K.'s problem. He just stays. For someone used to being processed by systems, being witnessed is disorienting and quietly healing." },
    SISYPHUS:       { score: 82, note: "Both have chosen to keep going against evidence. Alyosha's love and Sisyphus's revolt are different shapes of the same defiant yes." },
    RASKOLNIKOV:    { score: 55, note: "Alyosha is the person Raskolnikov would need to become to be saved. He knows this. He resists. He keeps returning anyway, which says everything." },
  },
  UNDERGROUND_MAN: {
    DEMIAN:         { score: 52, note: "Demian found his way through the dark; the Underground Man is still in it. Demian's integration irritates him — it looks too easy. He suspects it cost more than it shows." },
    STEPPENWOLF:    { score: 85, note: "The most honest mirror in the room. Both are hyper-conscious men at war with themselves. Their conversations go to places others won't follow. Dangerous. Necessary." },
    ROQUENTIN:      { score: 88, note: "Two people who see through everything and are paralyzed by the seeing. They will spend hours on a single sentence, following it down. Nobody else has the patience for this. They do." },
    ZARATHUSTRA:    { score: 28, note: "The Underground Man is the Last Man Zarathustra fears becoming. This is not contempt — it is recognition of a near miss. The relationship is a mirror neither fully wants." },
    DIONYSUS:       { score: 20, note: "The Underground Man finds a reason to doubt every yes the Dionysian makes. The relationship is quietly exhausting for both." },
    MEURSAULT:      { score: 50, note: "Both see through social performance. But the Underground Man seethes; Meursault is simply present. He finds this either enviable or infuriating depending on the day." },
    GREGOR:         { score: 55, note: "The Underground Man sees Gregor's trap clearly and says so, unkindly. It hurts. It's also the most honest thing anyone has said to him." },
    JOSEF_K:        { score: 78, note: "They understand each other's paralysis intimately. Long silences, then sudden bursts of painful honesty. The risk: they keep each other stuck." },
    SISYPHUS:       { score: 32, note: "Sisyphus has the one thing the Underground Man lacks: the capacity to act despite knowing. He finds this admirable or incomprehensible. Usually the latter." },
    RASKOLNIKOV:    { score: 80, note: "Two brilliant men who turned intelligence against themselves. They understand each other's self-destruction in granular detail. Addictive and dangerous." },
    ALYOSHA:        { score: 45, note: "Alyosha loves him without requiring him to be better. He finds this unbearable. He keeps testing it. It keeps holding. He doesn't know what to do with that." },
  },
  DEMIAN: {
    STEPPENWOLF:    { score: 82, note: "Demian has found what Steppenwolf is looking for. Not an answer — a method. He doesn't give it away. He makes Haller work for it, which is the only way it holds." },
    ROQUENTIN:      { score: 58, note: "Demian finds meaning in the abyss; Roquentin finds nausea. Close to the same territory, different conclusions. A generative tension if both are willing." },
    ZARATHUSTRA:    { score: 80, note: "Demian is Zarathustra's student who graduated early. Equal parts admiration and rivalry. Both trying to live at the edge of what's possible." },
    DIONYSUS:       { score: 85, note: "Two people who have integrated their shadow. They recognize it in each other immediately. The bond is deep and requires no explanation." },
    MEURSAULT:      { score: 60, note: "Demian sees Meursault's detachment as a threshold, not a destination. Meursault doesn't know what he means. He finds him interesting. That's saying something." },
    GREGOR:         { score: 68, note: "Demian looks at Gregor and sees the transformation that hasn't happened yet. He doesn't turn away. That matters enormously." },
    JOSEF_K:        { score: 50, note: "Demian sees a door where K. sees a wall. Intriguing, but K. suspects Demian's freedom is a story he tells himself." },
    SISYPHUS:       { score: 76, note: "Demian is still building his boulder. Sisyphus has been pushing his for years. There's wisdom to offer, if Demian is willing to receive it." },
    RASKOLNIKOV:    { score: 68, note: "Demian has integrated what Raskolnikov is trying to weaponize. A cautionary recognition — and something that might, over time, become mentorship." },
    ALYOSHA:        { score: 80, note: "Both integrating darkness and light — Alyosha through love, Demian through knowledge. They learn from each other without either fully converting the other." },
    UNDERGROUND_MAN:{ score: 52, note: "Demian found his way through the dark; the Underground Man is still in it. His integration irritates him — it looks too easy." },
  },
  STEPPENWOLF: {
    ROQUENTIN:      { score: 70, note: "Both are nauseated by their own existence in different ways. Roquentin by the raw facticity of things; Steppenwolf by his own multiplicity. They sit together in it without performing comfort." },
    ZARATHUSTRA:    { score: 55, note: "Harry has the will but not the direction. Zarathustra finds him interesting but unresolved. Haller finds Zarathustra's certainty both inspiring and suspect." },
    DIONYSUS:       { score: 78, note: "Harry Haller needs to learn to dance. The Dionysian can teach him — not the steps, but the permission. The most transformative pairing for Steppenwolf." },
    MEURSAULT:      { score: 45, note: "Harry's inner war bewilders Meursault, who has no such war. Occasionally Harry finds Meursault's stillness more peaceful than anything inside himself." },
    GREGOR:         { score: 60, note: "Both are living in forms that don't fit. Harry Haller recognizes the exhaustion. He won't romanticize it, which Gregor secretly appreciates." },
    JOSEF_K:        { score: 82, note: "Both are divided men trapped in forms that don't contain them. The bond is immediate and melancholy. They drink together and don't pretend." },
    SISYPHUS:       { score: 48, note: "Steppenwolf romanticizes his suffering; Sisyphus has deprogrammed exactly that. The conversations are useful. Haller resists them. He comes back." },
    RASKOLNIKOV:    { score: 62, note: "Both carry a divided self — Raskolnikov's moral, Steppenwolf's existential. They can be in a room without explaining themselves. That's rare." },
    ALYOSHA:        { score: 72, note: "Alyosha sees the person inside the war. He doesn't ask Harry to resolve it — just to be present to it. Haller finds this disarming. He was ready for a fight." },
    UNDERGROUND_MAN:{ score: 85, note: "The most honest mirror in the room. Both hyper-conscious men at war with themselves. Their conversations go to places others won't follow." },
    DEMIAN:         { score: 82, note: "Demian has found what Steppenwolf is looking for. Not an answer — a method. He makes Haller work for it, which is the only way it holds." },
  },
  ROQUENTIN: {
    ZARATHUSTRA:    { score: 32, note: "Roquentin's nausea and Zarathustra's affirmation are irreconcilable. Not enemies — just alien. Brief contact. Mutual bewilderment. Cold respect." },
    DIONYSUS:       { score: 25, note: "The Dionysian's affirmation is exactly what Roquentin cannot manage. They are irreconcilable — not hostile, just pointing in opposite directions." },
    MEURSAULT:      { score: 72, note: "Both notice the raw existence of things. Roquentin is nauseated; Meursault is simply there. Roquentin envies this — and suspects it might be its own blindness." },
    SISYPHUS:       { score: 55, note: "Roquentin sees the nausea at the bottom of things. Sisyphus has been there and named it something else. They are close to the same place with different maps." },
    RASKOLNIKOV:    { score: 58, note: "Roquentin sees Raskolnikov's guilt as a philosophical problem. Raskolnikov finds this cold. But Roquentin's clarity is the most honest diagnosis he's received." },
    ALYOSHA:        { score: 38, note: "Roquentin's nausea and Alyosha's love are at philosophical war. Yet Alyosha listens without arguing. This confuses Roquentin more than opposition would." },
    UNDERGROUND_MAN:{ score: 88, note: "Two people who see through everything and are paralyzed by it. They will spend hours on a single sentence following it down. Nobody else has the patience. They do." },
    DEMIAN:         { score: 58, note: "Demian finds meaning in the abyss; Roquentin finds nausea. Close to the same territory, different conclusions. A generative tension if both are willing." },
    STEPPENWOLF:    { score: 70, note: "Both nauseated by existence in different ways. They sit together in it without performing comfort. The bond is quiet and real." },
    GREGOR:         { score: 75, note: "Roquentin sees the obscene facticity of Gregor's existence without flinching. This is its own kind of witnessing." },
    JOSEF_K:        { score: 65, note: "Two people who notice what others don't — the absurdity, the excess, the weight of existing. Their conversations are the most honest either of them has." },
  },
};

function getCompatibility(idA, idB) {
  if (idA === idB) return { score: 100, note: "You are looking at yourself. What do you see?" };
  const data = COMPATIBILITY[idA]?.[idB] || COMPATIBILITY[idB]?.[idA];
  return data || { score: 50, note: "An uncharted connection. The silence between you contains something neither has named yet." };
}
...
// ── COMPAT CARD ──────────────────────────────────────────────────────────
function CompatCard({ arc, other, compat, status }) {
  ...
  return (
    <div onClick={() => setOpen(!open)} style={{
      background: open ? "#1a1408" : "#0e0c08",
      border: `1px solid ${open ? other.color + "55" : "#1e1608"}`,
      borderLeft: `3px solid ${status.color}`,
      borderRadius: "2px", cursor: "pointer",
      transition: "all 0.25s", padding: "1rem 1.25rem",
    }}>
      <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
        {/* Icon + name */}
        <span style={{ fontSize: "1.2rem", color: other.color }}>{other.icon}</span>
        <div style={{ flex: 1 }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            <div>
              <span style={{ color: "#c8b880", fontSize: "0.92rem" }}>{other.name}</span>
              <span style={{ color: "#3a2a0e", fontSize: "0.72rem", marginLeft: "0.5rem", fontStyle: "italic" }}>{other.author}</span>
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
              <span style={{ color: status.color, fontSize: "0.68rem", letterSpacing: "0.1em", textTransform: "uppercase", fontFamily: "'Courier New',monospace" }}>
                {status.symbol} {status.label}
              </span>
              <span style={{ color: status.color, fontWeight: "bold", fontSize: "0.95rem", minWidth: "2.2rem", textAlign: "right" }}>
                {pct}
              </span>
            </div>
          </div>
          {/* Score bar */}
          <div style={{ marginTop: "0.4rem", width: "100%", background: "#1a1208", height: 4, borderRadius: 2, overflow: "hidden" }}>
            <div style={{ width: `${pct}%`, height: "100%", background: status.color, opacity: 0.7, borderRadius: 2, transition: "width 1s ease" }} />
          </div>
        </div>
        <span style={{ color: "#3a2a0e", fontSize: "0.7rem", transition: "transform 0.2s", transform: open ? "rotate(180deg)" : "rotate(0deg)" }}>▾</span>
      </div>

      {open && (
        <div style={{ marginTop: "1rem", paddingTop: "1rem", borderTop: `1px solid ${other.color}22` }}>
          <div style={{ display: "flex", gap: "0.5rem", marginBottom: "0.75rem", flexWrap: "wrap" }}>
            <span style={{ border: `1px solid ${status.color}44`, color: status.color, padding: "0.2rem 0.6rem", fontSize: "0.68rem", borderRadius: "2px", fontFamily: "'Courier New',monospace" }}>
              {status.label.toUpperCase()}
            </span>
            <span style={{ color: "#4a3a1a", fontSize: "0.75rem", fontStyle: "italic" }}>{status.desc}</span>
          </div>
          <p style={{ margin: 0, color: "#8a7a5a", lineHeight: 1.75, fontSize: "0.88rem", fontFamily: font }}>
            {compat.note}
          </p>
          <div style={{ marginTop: "0.75rem", display: "flex", alignItems: "center", gap: "0.5rem" }}>
            <div style={{ height: 1, flex: 1, background: other.color + "22" }} />
            <span style={{ fontSize: "0.62rem", color: "#3a2a0e", letterSpacing: "0.1em", fontFamily: "'Courier New',monospace" }}>
              {arc.name.toUpperCase()} × {other.name.toUpperCase()}
            </span>
            <div style={{ height: 1, flex: 1, background: other.color + "22" }} />
          </div>
        </div>
    ...
    return (
      <div style={{minHeight:"100vh",background:arc.bg,fontFamily:font}}>
        ...
        <div style={{position:"relative",zIndex:1,borderBottom:`1px solid ${arc.color}18`,display:"flex",justifyContent:"center",opacity:revealStep>=2?1:0,transition:"opacity 0.5s ease 0.3s"}}>
          {["profile","clash","compat","scores","challenge"].map(tab=>(
            <button key={tab} onClick={()=>setActiveTab(tab)} style={{background:"none",border:"none",borderBottom:activeTab===tab?`2px solid ${arc.color}`:"2px solid transparent",color:activeTab===tab?arc.color:"#3a2a0e",padding:"0.85rem 1rem",cursor:"pointer",fontFamily:font,fontSize:"0.72rem",letterSpacing:"0.1em",textTransform:"uppercase",transition:"all 0.2s"}}>
              {tab==="clash"?(result.isClash?"⚡ Divided":"Resonances"):tab==="compat"?"Compatibility":tab.charAt(0).toUpperCase()+tab.slice(1)}
            </button>
          ))}
        </div>
        ...
        <div style={{maxWidth:720,margin:"0 auto",padding:"2rem",position:"relative",zIndex:1,opacity:revealStep>=3?1:0,transition:"opacity 0.6s ease 0.5s"}}>
          ...
          {activeTab==="compat"&&(
            <div>
              <p style={{color:"#7a6a45",fontStyle:"italic",marginBottom:"0.5rem",lineHeight:1.7,fontSize:"0.9rem"}}>
                How <span style={{color:arc.color}}>{arc.name}</span> relates to every other archetype — not as a personality test, but as a philosophical diagnosis of what each pairing produces.
              </p>
              {/* Legend */}
              <div style={{display:"flex",flexWrap:"wrap",gap:"0.5rem",marginBottom:"1.75rem"}}>
                {Object.entries(COMPAT_STATUS).map(([k,s])=>(
                  <div key={k} style={{display:"flex",alignItems:"center",gap:"0.4rem",border:`1px solid ${s.color}33`,borderRadius:"2px",padding:"0.25rem 0.6rem"}}>
                    <span style={{color:s.color,fontSize:"0.85rem"}}>{s.symbol}</span>
                    <span style={{fontSize:"0.65rem",color:s.color,letterSpacing:"0.08em"}}>{s.label}</span>
                  </div>
                ))}
              </div>
              ...
              <div style={{display:"grid",gap:"0.75rem"}}>
                {Object.keys(ARCHETYPES)
                  .filter(id => id !== result.primary)
                  .sort((a,b) => {
                    const sa = getCompatibility(result.primary, a)?.score || 0;
                    const sb = getCompatibility(result.primary, b)?.score || 0;
                    return sb - sa;
                  })
                  .map(id => {
                    const other = ARCHETYPES[id];
                    const compat = getCompatibility(result.primary, id);
                    const statusKey = getStatus(compat.score);
                    const status = COMPAT_STATUS[statusKey];
                    return (
                      <CompatCard key={id} arc={arc} other={other} compat={compat} status={status} />
                    );
                  })
                }
              </div>
