...
const ARCHETYPES = {
  JOSEF_K: {
    ...
    cardBgGradient: "linear-gradient(135deg, #120e08 0%, #1e1508 100%)",
  },
  GREGOR: {
    ...
    cardBgGradient: "linear-gradient(135deg, #0a120a 0%, #0e180e 100%)",
  },
  ZARATHUSTRA: {
    ...
    challenge: "The Overman is not above humanity — it is what humanity is capable of becoming. Descent is not defeat.",
    tensions: ["GREGOR", "ALYOSHA"],
    affinities: ["RASKOLNIKOV", "MEURSAULT"],
    cardBgGradient: "linear-gradient(135deg, #150f04 0%, #1e1508 100%)",
  },
  DIONYSUS: {
    id: "DIONYSUS", name: "The Dionysian", subtitle: "The Affirmer",
    author: "Nietzsche", work: "The Birth of Tragedy",
    ...
    traits: [
      ...
      { label: "Shadow Self", value: "Affirmation as avoidance. 'Yes to everything' is sometimes a refusal to discriminate what actually matters." },
    ],
    ...
    cardBgGradient: "linear-gradient(135deg, #110811 0%, #180f18 100%)",
  },
  MEURSAULT: {
    id: "MEURSAULT", name: "Meursault", subtitle: "The Stranger",
    author: "Camus", work: "The Stranger",
    color: "#6a9a9a", bg: "#080f0f", icon: "◇",
    summary: "You exist at a remove from the performances others take seriously. Social grief, moral outrage, romantic obligation — you observe these as a slightly baffled outsider. This is not coldness. It is radical honesty about what you actually feel versus what you're supposed to feel.",
    traits: [
      ...
      { label: "Hidden Strength", value: "Authenticity without effort. You cannot be manipulated by guilt or obligation." },
    ...
    cardBgGradient: "linear-gradient(135deg, #080f0f 0%, #0c1515 100%)",
  },
  SISYPHUS: {
    ...
    cardBgGradient: "linear-gradient(135deg, #120f06 0%, #1a1408 100%)",
  },
  RASKOLNIKOV: {
    ...
    cardBgGradient: "linear-gradient(135deg, #150a0a 0%, #1e0c0c 100%)",
  },
  ALYOSHA: {
    ...
    cardBgGradient: "linear-gradient(135deg, #15120a 0%, #1e180a 100%)",
  },
  UNDERGROUND_MAN: {
    ...
    cardBgGradient: "linear-gradient(135deg, #0c0c15 0%, #10101e 100%)",
  },
  DEMIAN: {
    id: "DEMIAN", name: "Demian", subtitle: "The Seeker Between Worlds",
    ...
    cardBgGradient: "linear-gradient(135deg, #0e120a 0%, #121808 100%)",
  },
  STEPPENWOLF: {
    id: "STEPPENWOLF", name: "Harry Haller", subtitle: "The Divided",
    ...
    cardBgGradient: "linear-gradient(135deg, #120e08 0%, #1a1208 100%)",
  },
  ROQUENTIN: {
    ...
    cardBgGradient: "linear-gradient(135deg, #0c0f08 0%, #101408 100%)",
  },
};

// ═══════════════════════════════════════════════════════════════════
// QUESTIONS — designed to make you pause
// ═══════════════════════════════════════════════════════════════════
const QUESTIONS = [
  {
    id: 1,
    scenario: "You are at a funeral. You did not know the person well, but others are weeping deeply. You feel nothing — or something so quiet it barely registers.",
    question: "What is the most honest thing you do with that?",
    choices: [
  ...
  {
    id: 2,
    scenario: "Someone you respect deeply tells you: 'I think you are capable of much more than you allow yourself.' They mean it kindly. You have heard it before.",
    question: "What is the feeling underneath your response?",
    choices: [
  ...
  {
    id: 3,
    scenario: "You are three years into something — a relationship, a career, a city — that is not bad. Not painful. Simply not yours. Leaving would hurt people who have done nothing wrong.",
  ...
  {
    id: 4,
    scenario: "You have done something you are not proud of — nothing catastrophic, but real. Nobody knows. A year passes. You have not repeated it. It has not left you.",
    question: "What do you do with the fact that it hasn't left you?",
    choices: [
  ...
  {
    id: 5,
    scenario: "A child asks you: 'Do you think people are mostly good?' They are young enough that your answer will shape something in them.",
  ...
  {
    id: 6,
    scenario: "At 3am, unable to sleep, you find yourself doing something you'd be embarrassed to admit in daylight — not shameful, just private. A ritual, an obsession, a thought you return to.",
    question: "What does that 3am self want that the daytime self won't admit?",
    choices: [
  ...
  {
    id: 7,
    scenario: "You are given undeniable evidence that a belief you have held for years — about yourself, about how the world works — is wrong. Not partially wrong. Wrong.",
  ...
  {
    id: 8,
    scenario: "You witness someone being publicly humiliated — not physically harmed, but genuinely degraded. You could intervene. It would cost you something real. Nobody would blame you for staying quiet.",
    question: "What determines whether you speak?",
    choices: [
  ...
  {
    id: 9,
    scenario: "You are offered a version of your life with all the difficulty removed. Same people, same work, same world — but the weight is gone. The grinding sense that things cost something. It would feel like relief.",
    ...
    choices: [
      ...
      { text: "No — but not nobly. Because you wouldn't trust it. The ease would feel like a trap.", weights: { JOSEF_K: 3, ROQUENTIN: 2, DEMIAN: 1 } },
      { text: "Yes, without guilt. Suffering is not a credential. Ease is not a betrayal.", weights: { MEURSAULT: 3, SISYPHUS: 2, ALYOSHA: 1 } },
    ],
  },
  {
    id: 10,
    scenario: "At the end of your life — imagining it now, honestly — you are asked to name the thing you protected most carefully. Not what you built or achieved. What you protected.",
    question: "What is it?",
    choices: [
...
// ═══════════════════════════════════════════════════════════════════
const CLASHES = {
  "JOSEF_K-MEURSAULT": { title: "The Accused vs. The Stranger", description: "Part of you fights the system anxiously; part of you doesn't register it as real. These are two responses to the same absurd world — and you contain both." },
  "ZARATHUSTRA-UNDERGROUND_MAN": { title: "The Overcomer vs. The Paralyzed", description: "You have the firepower of both — one pushes upward, the other spirals inward. On good days you are Zarathustra. On dark days, the Underground Man. The question is which one is choosing." },
  ...
  "DEMIAN-ROQUENTIN": { title: "The Seeker vs. The Nauseated", description: "Both have looked beneath the surface and cannot look away. But Demian finds meaning in the darkness; Roquentin finds only excessive existence. You oscillate between them." },
  "STEPPENWOLF-DIONYSUS": { title: "The Divided vs. The Affirmer", description: "You contain contradictions — but are you at war with them or dancing with them? Your score suggests you are somewhere between the suffering and the celebration." },
  "GREGOR-RASKOLNIKOV": { title: "The Transformed vs. The Transgressor", description: "One erases himself for others; one believes he transcends them. You carry both — the self-effacing servant and the secretly convinced exceptional. They are in permanent quiet war." },
  "ALYOSHA-ZARATHUSTRA": { title: "The Luminous vs. The Overcomer", description: "Love versus will. You want to love people as they are and push them to become more. This is either wisdom or an impossible demand — you haven't decided which." },
};
...
const ProgressBar = ({ total, current }) => (
  <div style={{ display: "flex", gap: "5px", justifyContent: "center", marginBottom: "2rem" }}>
    {Array.from({ length: total }).map((_, i) => (
      <div key={i} style={{ height: 6, borderRadius: 3, width: i < current ? 28 : i === current ? 16 : 8, background: i < current ? "#A0845C" : i === current ? "#c8b880" : "#2a1e0e", transition: "all 0.4s ease" }} />
    ))}
  </div>
);

// ═══════════════════════════════════════════════════════════════════
// SHARE CARD — renders to canvas and downloads as PNG
// ═══════════════════════════════════════════════════════════════════
const ShareCardModal = ({ result, onClose }) => {
  ...
  const drawCard = useCallback(() => {
    ...
    bgGrad.addColorStop(0, arc.bg);
    bgGrad.addColorStop(1, arc.bg + "ee");
    ...
    // Subtle grid pattern
    ctx.strokeStyle = arc.color + "08";
    ctx.lineWidth = 1;
    for (let x = 0; x < W; x += 40) { ctx.beginPath(); ctx.moveTo(x, 0); ctx.lineTo(x, H); ctx.stroke(); }
    for (let y = 0; y < H; y += 40) { ctx.beginPath(); ctx.moveTo(0, y); ctx.lineTo(W, y); ctx.stroke(); }

    // Top border line
    ctx.fillStyle = arc.color + "33";
    ctx.fillRect(0, 0, W, 1);
    ctx.fillRect(0, H - 1, W, 1);

    // Author label
    ctx.font = "11px 'Courier New', monospace";
    ctx.fillStyle = arc.color + "99";
    ctx.letterSpacing = "3px";
    ctx.fillText((arc.author + " — " + arc.work).toUpperCase(), 36, 52);

    // Big icon
    ctx.font = "52px serif";
    ctx.fillStyle = arc.color + "55";
    ctx.fillText(arc.icon, W - 90, 90);

    // Name
    ctx.font = "bold 58px 'Georgia', serif";
    ctx.fillStyle = "#e8d5a3";
    ctx.fillText(arc.name, 36, 116);

    // Subtitle
    ctx.font = "italic 20px 'Georgia', serif";
    ctx.fillStyle = arc.color + "bb";
    ctx.fillText(arc.subtitle, 38, 146);

    // Divider
    ctx.fillStyle = arc.color + "44";
    ctx.fillRect(36, 162, 200, 1);

    // Summary — word wrap
    ctx.font = "15px 'Georgia', serif";
    ctx.fillStyle = "#9a8a6a";
    const words = arc.summary.split(" ");
    let line = "", y = 190, maxW = W - 72;
    for (let w of words) {
      const test = line + w + " ";
      if (ctx.measureText(test).width > maxW && line !== "") {
        ctx.fillText(line.trim(), 36, y);
        line = w + " "; y += 22;
        if (y > 295) { ctx.fillText(line.trim() + "…", 36, y); line = ""; break; }
      } else { line = test; }
    }
    if (line) ctx.fillText(line.trim(), 36, y);

    // Shadow self section
    const shadowTrait = arc.traits.find(t => t.label === "Shadow Self");
    if (shadowTrait) {
      ctx.font = "10px 'Courier New', monospace";
      ctx.fillStyle = arc.color + "77";
      ctx.fillText("SHADOW SELF", 36, 330);
      ctx.font = "italic 13px 'Georgia', serif";
      ctx.fillStyle = "#6a5a35";
      const sw = shadowTrait.value;
      const swWords = sw.split(" ");
      let swLine = "", swY = 348;
      for (let w of swWords) {
        const t = swLine + w + " ";
        if (ctx.measureText(t).width > maxW && swLine !== "") {
          ctx.fillText(swLine.trim(), 36, swY); swLine = w + " "; swY += 18;
          if (swY > 385) break;
        } else { swLine = t; }
      }
      if (swLine) ctx.fillText(swLine.trim(), 36, swY);
    }

    // Quote box
    ctx.fillStyle = arc.color + "18";
    roundRect(ctx, 36, 398, W - 72, 56, 2);
    ctx.fill();
    ...
    const quoteText = `"${arc.quote}"`;
    const quoteWords = quoteText.split(" ");
    let qLine = "", qY = 418;
    for (let w of quoteWords) {
      const t = qLine + w + " ";
      if (ctx.measureText(t).width > maxW - 20 && qLine !== "") {
        ctx.fillText(qLine.trim(), 48, qY); qLine = w + " "; qY += 18;
        if (qY > 446) break;
      } else { qLine = t; }
    }
    if (qLine) ctx.fillText(qLine.trim(), 48, qY);

    // Secondary archetype badge
    ctx.font = "11px 'Courier New', monospace";
    ctx.fillStyle = "#3a2a0e";
    ctx.fillText("RESONATES WITH", 36, H - 18);
    ctx.fillStyle = secArc.color + "bb";
    ctx.fillText(`${secArc.icon} ${secArc.name.toUpperCase()} (${secArc.author.toUpperCase()})`, 160, H - 18);

    // Watermark
    ctx.font = "10px 'Courier New', monospace";
    ctx.fillStyle = "#2a1e0e";
    ctx.textAlign = "right";
    ctx.fillText("THE LITERARY SOUL", W - 36, H - 18);
    ctx.textAlign = "left";
  ...
  const downloadImage = () => {
    ...
    link.download = `literary-soul-${arc.name.toLowerCase().replace(/\s/g, "-")}.png`;
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "#000000dd", zIndex: 200, display: "flex", alignItems: "center", justifyContent: "center", padding: "1rem", fontFamily: font }} onClick={onClose}>
      <div style={{ maxWidth: 860, width: "100%" }} onClick={e => e.stopPropagation()}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1rem" }}>
          <p style={{ margin: 0, color: "#5a4a2a", fontSize: "0.75rem", letterSpacing: "0.2em", textTransform: "uppercase" }}>Your shareable card</p>
          <button onClick={onClose} style={{ background: "none", border: "none", color: "#4a3a1a", cursor: "pointer", fontSize: "1.5rem", fontFamily: font }}>×</button>
        </div>

        {/* Canvas preview */}
        <canvas ref={canvasRef} style={{ width: "100%", display: "block", border: `1px solid ${arc.color}33`, borderRadius: "2px", marginBottom: "1rem" }} />

        <button onClick={downloadImage} disabled={!rendered} style={{
          width: "100%", background: rendered ? "none" : "#1a1208",
          border: `1px solid ${arc.color}${rendered ? "99" : "33"}`,
          color: rendered ? arc.color : "#3a2a0e",
          padding: "1rem", fontFamily: font, fontSize: "0.85rem",
          letterSpacing: "0.2em", textTransform: "uppercase",
          cursor: rendered ? "pointer" : "default", borderRadius: "2px",
          transition: "all 0.3s"
        }}>
          {downloading ? "Downloading…" : rendered ? "⬇ Download as Image" : "Rendering…"}
        </button>
      </div>
    </div>
  );
  ...
  const choose = (choice) => {
    ...
    setTimeout(() => {
      ...
      if (qIndex + 1 < QUESTIONS.length) {
        setAnswers(newAnswers); setQIndex(qIndex + 1); setSelected(null); setFading(false);
      } else {
        const r = computeResult(newAnswers);
        setResult(r); setPhase("result"); setFading(false);
    ...
    <div style={{ minHeight: "100vh", background: "#080604", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "2rem", fontFamily: font }}>
      ...
      <div style={{ maxWidth: 600, width: "100%", position: "relative", zIndex: 1 }}>
        ...
        <div style={{ background: "#120e08", border: "1px solid #2a1e0e", borderLeft: "3px solid #6b5a35", padding: "1.5rem", marginBottom: "2rem", borderRadius: "2px" }}>
          <p style={{ margin: "0 0 0.75rem", color: "#9a8a6a", lineHeight: 1.8 }}>Ten situations. No correct answers. Each question is designed to make you pause — not because the choice is difficult, but because it requires you to be honest about who you actually are, not who you intend to be.</p>
          <p style={{ margin: 0, color: "#5a4a2a", fontSize: "0.85rem", fontStyle: "italic" }}>Your result: primary archetype · resonant secondary · clash detection if your soul is divided · a downloadable portrait card · comparison mode.</p>
        </div>
      ...
      <div style={{ minHeight: "100vh", background: "#080604", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "2rem", fontFamily: font }}>
        ...
        <div style={{ maxWidth: 640, width: "100%", position: "relative", zIndex: 1 }}>
          ...
          <div style={{ opacity: fading ? 0 : 1, transform: fading ? "translateY(-10px)" : "translateY(0)", transition: "all 0.4s ease" }}>
            ...
            <h2 style={{ margin: "0 0 1.5rem", color: "#c8b880", fontWeight: 400, fontSize: "1.15rem", textAlign: "center", letterSpacing: "0.01em" }}>{q.question}</h2>
          ...
          <div style={{ display: "flex", gap: "0.75rem", justifyContent: "center", flexWrap: "wrap" }}>
            {[
              ...
              <button key={btn.label} onClick={btn.action} style={{ background: btn.primary ? arc.color + "22" : "none", border: `1px solid ${arc.color}${btn.primary ? "99" : "44"}`, color: arc.color, padding: "0.55rem 1.25rem", fontSize: "0.78rem", letterSpacing: "0.15em", textTransform: "uppercase", cursor: "pointer", fontFamily: font, borderRadius: "2px", transition: "all 0.2s" }}
                onMouseEnter={e => e.currentTarget.style.background = arc.color + "33"}
                onMouseLeave={e => e.currentTarget.style.background = btn.primary ? arc.color + "22" : "none"}
              >{btn.label}</button>
            ))}
          </div>
        </div>
                ...
                {[...new Set([arc.author, secArc?.author])].filter(Boolean).flatMap(author =>
                  Object.values(ARCHETYPES).filter(a => a.author === author).map(a => (
                    <div key={a.id} style={{ display: "flex", gap: "0.5rem", marginBottom: "0.5rem", alignItems: "center" }}>
                      <span style={{ color: AUTHOR_COLORS[author] }}>{a.icon}</span>
